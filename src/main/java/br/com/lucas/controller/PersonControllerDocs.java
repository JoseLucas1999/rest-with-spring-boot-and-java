...
//----------------------------------------------------------------------------------------------------------------------------------------------------------	
	/*
	 * @Operation: Ela documenta o que esse endpoint faz para que apareça bonitinho
	 * no Swagger UI título desse endpoint. Explica melhor o que o endpoint faz.
	 * Tags servem para organizar os endpoints em categorias. Aqui começa a lista de
	 * possíveis respostas que o endpoint pode retornar Se der tudo certo (200 OK),
	 * a resposta vai ser um JSON array de objetos PersonDTO é retornado um array
	 */
...
//----------------------------------------------------------------------------------------------------------------------------------------------------------		
	//	aqui não retornaremos mais um array
